...
import com.example.train.member.enums.PassengerTypeEnum;
...
public class EnumGenerator {
    ...
    public static void main(String[] args){
        ...
        System.out.println("生成枚举文件耗时："+(end-begin)+"毫秒");
    }
    ...
    private static void formatJsonObj(StringBuffer bufferObject, List<Field> targetFields, Class clazz, Object obj) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException {
        bufferObject.append("{");
